// $ANTLR 3.4 compiler/ast/GramaticaAst.g 2013-10-14 00:17:59
        ...
        try {
            ...
            switch (alt10) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: id, block, id, VOID, type
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: block, id, type, id, type
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
        ...
        try {
            ...
            switch (alt16) {
                ...
                case 4 :
                    ...
                    // AST REWRITE
                    // elements: ASSIGN, expr, FOR, id, expr, block
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
