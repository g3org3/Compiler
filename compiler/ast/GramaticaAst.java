// $ANTLR 3.4 compiler/ast/GramaticaAst.g 2013-10-19 15:32:34
        ...
        try {
            ...
            switch (alt10) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: type, block, VOID, id, id
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: id, type, type, block, id
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
        ...
        try {
            ...
            switch (alt16) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: assign_op, location, expr
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 3 :
                    ...
                    // AST REWRITE
                    // elements: block, block, expr, IF, ELSE
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 4 :
                    ...
                    // AST REWRITE
                    // elements: expr, FOR, id, ASSIGN, block, expr
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
